 ...
 * 
 */
@WebServiceClient(name = "TestService", targetNamespace = "http://booking.xws.ftn.rs/test", wsdlLocation = "https://localhost:8443/services/TestService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://localhost:8443/services/TestService?wsdl");
